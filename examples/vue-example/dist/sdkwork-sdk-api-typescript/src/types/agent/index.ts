import { DataScope, PlatformOwner } from '../../enums/enums';
import { AgentStatus, AgentType, AgentBizType } from '../../enums/agent';
...
export interface AiAgentParam extends BaseParam {
    ...
    /**
     * prompt字段
     * Java类型: com.sdkwork.spring.ai.plus.form.agent.PlusAiAgentForm$AiAgentSystemPrompt
     * 描述: System prompt
     */
