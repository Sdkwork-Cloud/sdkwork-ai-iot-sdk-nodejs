 ...
 */
export class Knowledge_baseChatManager extends BaseSdkManager<SdkClient> {
  ...
  try {
    ...
    const response = await this._client.knowledge_base.chat.create(data, queryParams, options);
    if ( data.stream ) {
