import { DiskMemberPermission, FileCategory, FileStorageClass, FileStatus } from '../../enums/files';
...
import { FilePermission } from '../../types/io';
/**
 * 自动生成的TypeScript接口定义
...
export interface DiskMemberParam extends BaseParam {
     ...
     * 描述: 成员权限集合（位运算表示）
     */
    permission?: Array<DiskMemberPermission>;
    /**
     * remark字段
