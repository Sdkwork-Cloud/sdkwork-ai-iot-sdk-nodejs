...
import { CloudAccountConfig, MusicAccountConfig, SearchAccountConfig, OAuthAccountConfig, KnowledgeAccountConfig, OcrAccountConfig, SmsAccountConfig, AudioAccountConfig, EmbeddingAccountConfig, VectorAccountConfig, MemoryAccountConfig, AgentAccountConfig, OssAccountConfig, OfficialAccountConfig, VideoAccountConfig, ModerationAccountConfig, DatasourceAccountConfig, AppStoreAccountConfig, FilesAccountConfig, ApiKeyAccountConfig, ImAccountConfig, MiniProgramAccountConfig, ImageAccountConfig, NewsAccountConfig, RtcAccountConfig, LlmAccountConfig, ToolAccountConfig, PayAccountConfig } from '../../types/config.resource';
/**
 * 自动生成的TypeScript接口定义
