 ...
 * 支持id和uuid的比较，处理空值情况
 */
export const isConversationMatch = (conversation: ConversationVO, targetId: string | null | undefined): boolean => {
 ...
 * 支持id和uuid的比较，处理空值情况
 */
export const isSameConversation = (c1: ConversationVO | null | undefined, c2: ConversationVO | null | undefined): boolean => {
  if (!c1 || !c2) {
    return false;
  }
