<template>
  <div class="message-content-video">
    <div class="video-container" @click="togglePlay">
      <video ref="videoElement" :src="videoUrl" :poster="videoPoster" class="message-video"
        @loadedmetadata="handleVideoLoad" @timeupdate="handleTimeUpdate" @ended="handleVideoEnd" />
...
import { MsgVideoContent, MsgPayload } from 'sdkwork-sdk-api-typescript'
interface Props {
...
const videoUrl = computed(() => {
  ...
  const video: MsgVideoContent = payload?.video as any
  return video?.resource?.url
})
