<template>
  <div class="waterfall-demo">
    <h1>SDKWork API Waterfall 组件演示</h1>
    <p>这是一个瀑布流组件的演示页面，展示了如何使用瀑布流布局展示商品数据。</p>
    ...
    <div class="action-buttons">
      <van-button type="primary" @click="handleRefresh">刷新数据</van-button>
...
const mockProducts: Product[] = [
  ...
  },
  {
    ...
    name: '智能家居中心',
    price: 1599,
    image: 'https://via.placeholder.com/300x300/6c757d/ffffff?text=SmartHome',
    rating: 4.5,
    sales: 920,
    description: '智能家居控制中心，支持多种设备连接'
  },
  {
    id: '10',
    name: 'VR眼镜 Pro',
    price: 2999,
    image: 'https://via.placeholder.com/300x280/0dcaf0/ffffff?text=VR',
    rating: 4.3,
    sales: 380,
    description: '虚拟现实眼镜，沉浸式游戏体验'
  },
  {
    id: '11',
    name: '无人机 Explorer',
    price: 4599,
    image: 'https://via.placeholder.com/300x320/198754/ffffff?text=Drone',
    rating: 4.7,
    sales: 210,
    description: '高清航拍无人机，智能跟随功能'
  },
  {
    id: '12',
    name: '电动滑板车',
    price: 1999,
    image: 'https://via.placeholder.com/300x250/ffc107/000000?text=Scooter',
    rating: 4.4,
    sales: 650,
    description: '便携电动滑板车，续航里程长'
  }
]
