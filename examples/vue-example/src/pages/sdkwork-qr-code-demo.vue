  ...
  <div class="qr-demo-container">
    ...
    <div class="demo-section">
      ...
      <div class="demo-wrapper">
        <SdkworkQrCode
          title="活动邀请函"
          description="扫码查看活动详情"
          avatar="https://picsum.photos/seed/avatar5/200/200.jpg"
          value="https://picsum.photos/seed/qrcode1/300/300.jpg"
          tip-text="扫码参加活动"
          qr-mode="image"
          :qr-size="240"
        />
    ...
    <div class="demo-section">
      ...
      <div class="demo-wrapper">
        <SdkworkQrCode
          ...
          avatar="https://picsum.photos/seed/avatar6/200/200.jpg"
          value="BEGIN:VCARD
VERSION:3.0
FN:张三
TEL:13800138000
...
import SdkworkQrCode from '@/components/sdkwork-qr-code/index.ts'  
